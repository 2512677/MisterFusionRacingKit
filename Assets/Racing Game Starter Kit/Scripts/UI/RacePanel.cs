    ...
    public class RacePanel : MonoBehaviour
    {
        ...
        void UpdateLapTimers()
        {
            ...
            if (raceEndTimer != null)
            {
                ...
                {
                    raceEndTimer.text = "Race End: " + (int)RaceManager.instance.raceEndTimer;
                }
            }
        }
        ...
        void UpdateProgressText()
        {
			...
			if (raceProgress != null && RaceManager.instance.playerStatistics != null)
            {
                raceProgress.text = lapProgressPrefix + " " + (int)RaceManager.instance.playerStatistics.raceCompletionPercentage + "%";
            }
        }
        ...
        void UpdateDistanceDrivenText()
        {
			...
			if (distanceDriven != null && RaceManager.instance.playerStatistics != null)
            {
