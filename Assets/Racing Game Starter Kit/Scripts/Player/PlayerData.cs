...
namespace RGSK
{
    public class PlayerData : MonoBehaviour
    {
        ...
        {
            if (IsItemUnlocked(id)) // Проверка, разблокирован ли предмет
                return;

            playerData.items.Add(id); // Добавление предмета в список
            SaveData(); // Сохранение данных
        }
    ...
    public class DataContainer
    {
        ...
        public List<string> items = new List<string>(); // Разблокированные предметы
